<?
	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->sql2="select b.codcar, count (a.codemp) as canemp, c.nomcar, c.suecar, d.nomnom, b.codnom, c.carvan
	...
	//	print '<pre>'; print $this->sql2; exit;
		...
		function llenartitulosmaestro()
		{
				...
				$this->titulos[3]="Cargos Asignados";
				$this->titulos[4]="Cargos Vacantes";
		}
		function getAncho()
		{
