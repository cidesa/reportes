...
$arrsueldo = $this->objNprhisrecpag->sqlcalulasueldo($obj["nomina2"],$obj["codemp"],$this->fecnomdes,$this->fecnomhas);
      $this->cell(30,5,H::FormatoMonto($arrsueldo[$this->index]["valor"]),0,0,"R");/////// COMENTADO PARA NO IMPRIMIR EL SUELDO
      $this->setFont("Arial","B",8);
      $this->ln();
      $this->cell(5,5,"");
   ...
   $this->ln(20);
         ...
         // $arrsueldo = $this->objNprrecpag->sqlcalulasueldo2($obj["codemp"]);
          $arrsueldo = $this->objNprhisrecpag->sqlcalulasueldo($obj["nomina2"],$obj["codemp"],$this->fecnomdes,$this->fecnomhas);
          $this->cell(30,5,H::FormatoMonto($arrsueldo[$this->index]["valor"]),0,0,"R");  ///COMENTADO PARA QUE NO IMPRIMA SUELDO
