		...
		function Cuerpo()
	    {
			...
			foreach ($this->arrp4 as $arrp4)
			{
				...
				if($arrp4["codemp"]==$ref4)
				{
					...
					$this->setFont("Arial","",9);
					$this->SetXY(10,225);
					$this->Cell(50,5,'Direccion: Av. Francisco de Miranda, Centro Plaza Torre C, Piso 20, Urb, Los Palos Grandes ',0,0,'L');
					$this->ln();
					$this->Cell(50,5,'Agente de Retencion: CONTRALORIA MUNICIPAL DEL MUNICIPIO CHACAO',0,0,'L');
					$this->ln();
