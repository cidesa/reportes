<?
  ...
  require_once("../../lib/general/cabecera.php");
    ...
    require_once("../../lib/modelo/sqls/facturacion/Fagrecaud.class.php");
...
function llenartitulosmaestro()
    {
        $this->titulos[1]="CÓDIGO GRUPO";
        $this->titulos[2]="DESCRIPCIÓN GRUPO";
   ...
   foreach($this->arrp as $dato){
	   ...
	   $this->SetWidths(array(50,140));
       $this->SetAligns(array("C","L"));
	   $this->RowM(array($dato["codtiprec"],$dato["destiprec"]));
	   $this->SetBorder(0);
	   $this->SetFillTable(0);
       $y = $this->GetY();
       if ($y >= 200)
