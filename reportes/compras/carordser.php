...
<?php  include_once("../../lib/general/formtop.php")?>
		...
		?>" class="breadcrumb" id="ordcomhas" size="12" maxlength="8">
  		...
  		<a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('carordser',5); "></a>
            ...
            <tr>
              <td height="24" class="form_label_01"><div align="left"><strong>Coordinador (a) Compras:</strong></div></td>
              <td colspan="2" valign="top"><div align="left">
                  <input name="coorcom" type="text" value="" id="coorcom" size="40" maxlength="45" class="breadcrumb">
              </div></td>
            </tr>
            <tr>
              <td height="24" class="form_label_01"><div align="left"><strong>jefe (a) Compras:</strong></div></td>
              <td colspan="2" valign="top"><div align="left">
                  <input name="jefecom" type="text" value="" id="jefecom" size="40" maxlength="45" class="breadcrumb">
              </div></td>
            </tr>
            <tr>
              <td height="24" class="form_label_01"><div align="left"><strong>Director (a) de Administracion y Finanzas:</strong></div></td>
              <td colspan="2" valign="top"><div align="left">
                  <input name="diradm" type="text" value="" id="diradm" size="40" maxlength="45" class="breadcrumb">
              </div></td>
            </tr>
            <tr>
              <td height="24" class="form_label_01"><div align="left"><strong>Director (a) General Ejecutivo (a):</strong></div></td>
              <td colspan="2" valign="top"><div align="left">
                  <input name="dirgeneje" type="text" value="" id="dirgeneje" size="40" maxlength="45" class="breadcrumb">
              </div></td>
            </tr>
