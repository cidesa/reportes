...
class pdfreporte extends PDF_ADDS {
	...
	$this->arrp=array("no_vacio");
		...
		if ($_GET["ordcomdes"] != "") {
			...
			B.MONTOT AS MONAJU,B.CANORD AS CANORD,F.CANAJU AS CANAJU,F.CANREC AS CANREC,F.CANTOT AS CANTOT,
		...
		//print '<pre>';	print				$this->sql; exit;
			...
			B.MONTOT AS MONAJU,F.CANAJU AS CANAJU,F.CANREC AS CANREC,F.CANORD AS CANTOT,
			F.COSTO AS PREART,F.RGOART AS RGOART,F.TOTART AS TOTART,(C.DESART) AS DESART,--B.UNIMED AS UNID,
