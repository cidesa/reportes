...
$this->cab=new cabecera();
		...
		function llenartitulosmaestro()
		{
				...
				$this->titulosm[8]=$this->Empresa('nombre');
				...
				$this->titulosm[31]='DIRECCION DE PLANIFICACION Y PRESUPUESTO';
				$this->titulosm[32]='GERENCIA DE LOGISTICA';
				$this->titulosm[33]='UNIDAD SOLICITANTE';
				$this->titulosm[34]='CONTRALOR MUNICIPAL';
				$this->titulosm[35]='FIRMA Y SELLO';

				$this->titulosm[100]=$this->Empresa('direccion').' '.$this->Empresa('telf').' '.$this->Empresa('fax');
		...
		function Header()
		{
			$this->cab->poner_cabecera_f2($this,"REQUISICIÓN",$this->conf,"n","n");
