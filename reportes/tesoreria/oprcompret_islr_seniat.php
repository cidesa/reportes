  ...
  <tr>
			  ...
			  ?>
                <select name="ben" class="breadcrumb" id="ben">
                 <option VALUE=""> </option>
                <?
                LlenarComboSql($tb2,"valor","vista",'',$bd);
                ?>
                </select>
              </td>
            </tr>
...
{
 	pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT distinct(a.numord) as Numero from opfactur a, opordpag b, opretord c, tsrepret d where a.numord=b.numord and b.numord=c.numord and a.monislr>0 and c.codtip=d.codret order by a.numord";
