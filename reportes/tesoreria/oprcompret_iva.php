...
<?
$tb = $bd->select("SELECT distinct(a.numord) as numord,comret
...
?>
                                    ...
                                    <tr>
                                        <td class="form_label_01"> <div align="left"><strong>N&uacute;mero Nota de D&eacute;bito:</strong></div></td>
                                        <td colspan="2"> <div align="left">
                                                <input name="debito" type="text" class="breadcrumb" id="debito" value="" size="30">
                                            </div></td>
                                    </tr>
                                    <tr>
                                        <td class="form_label_01"> <div align="left"><strong>N&uacute;mero Nota de Cr&eacute;dito:</strong></div></td>
                                        <td colspan="2"> <div align="left">
                                                <input name="credito" type="text" class="breadcrumb" id="credito" value="" size="30">
                                            </div></td>
                                    </tr>
                                    <tr>
                                        <td class="form_label_01"> <div align="left"><strong>Tipo de Transacci&oacute;n:</strong></div></td>
                                        <td colspan="2"> <div align="left">
...
?>
                                    ...
                                    <tr>
                                        <td class="form_label_01"><strong>Habilitar Actualizaci&oacute;n:</strong></td>
                                        <td>
