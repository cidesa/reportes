<?
	...
	class pdfreporte extends fpdf
	{
		...
		function Header()
		{
			...
			$this->ln(14);
			$this->setFont("Arial","B",9);
			$this->Cell(20,5,'NOMBRE DEL ENTE PUBLICO: La Nueva Televisora del Sur, C.A.');
			$this->ln();
			$this->Cell(200,5,'DIRECCION: Calle Vargas con Santa Clara, Edif.Telesur,piso 1,Urb. Boleita Norte, Zona Postal 1070.Edo Miranda.');
			$this->ln(); 
			$this->Cell(20,5,'PERIODO DEL '.$this->fechades.' AL '.$this->fechahas);
			//$this->ln();
			//$this->Cell(20,5,'Nro PLANILLA(S) BANCARIAS: ');
			$this->ln();
			$this->Cell(20,5,'RIF: G-20004500-0');
				$this->ln();
			$this->ln(10);
