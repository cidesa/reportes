...
{
 	mysql="SELECT distinct a.numord as numord,b.nomben from opfactur a, opordpag b, opretord c, tsrepret d where a.numord=b.numord and b.numord=c.numord and d.codrep='003' and c.codtip=d.codret order by a.numord";
