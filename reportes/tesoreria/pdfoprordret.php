	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->ben2=$_POST["benhas"];
                ...
                $this->ret1=$_POST["tipdes"];
			$this->ret2=$_POST["tiphas"];
...
B.codtip >= '".$this->ret1."' AND B.codtip <= '".$this->ret2."' AND
		...
		while (!$tb->EOF)
		{
				...
				$this->SetLineWidth(0.2);
				 ...
				 $this->sql2="select B.CODTIP,C.DESTIP,(case when B.NUMRET='NOASIGNA' then '' else B.NUMRET end) as NUMRET,B.CODPRE,D.NOMPRE,B.MONRET as mret
							...
							where
							B.CODTIP = C.CODTIP AND
B.codtip >= '".$this->ret1."' AND B.codtip <= '".$this->ret2."' AND B.CODPRE = D.CODPRE AND b.NUMORD = '".$numord."'
							ORDER BY b.CODTIP";
		...
		$this->sql5="SELECT A.CODTIP as CODTIPTOT,B.DESTIP as DESTIPTOT,SUM(A.MONRET) as MONRETTOT
					...
					WHERE A.CODTIP = B.CODTIPZZZ AND
A.codtip >= '".$this->ret1."' AND A.codtip <= '".$this->ret2."' 
