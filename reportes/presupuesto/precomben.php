...
<!------------------------------------------------------------------------------------------------------- -->
            ...
            <tr bordercolor="#6699CC">
              ...
              <td>
			    <?
			  	$tb=$bd->select("SELECT DISTINCT(TIPCOM) as tip, NOMABR as nom FROM CPDOCCOM order by tipcom");
			    ?>
            ...
            <tr bordercolor="#6699CC">
              <td class="form_label_01"><strong>Estado:</strong></td>
              <td colspan="2"> <select name="estadocompromiso" class="breadcrumb" id="estadocompromiso">
                  <option>Todos</option>
                  <option>Sin Causar</option>
                  <option>Causado No Pagado</option>
                  <option>Causado y Pagado</option>
                </select></td>
            </tr>

            <tr bordercolor="#6699CC">
              <td class="form_label_01"><strong>Resumido:</strong></td>
              <td colspan="2"> <select name="resumido" class="breadcrumb" id="resumido">
