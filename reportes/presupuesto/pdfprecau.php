...
class pdfreporte extends fpdf {
    ...
    function pdfreporte() {
        ...
        // nro de compromiso
        $this->pre1 = H::GetPost("pre1") . H::GetPost("refcau1");
        $this->pre2 = H::GetPost("pre2") . H::GetPost("refcau2");
        // fecha del compromiso
        $this->fecprc1 = H::GetPost("fecprc1") . H::GetPost("feccau1");
        $this->fecprc2 = H::GetPost("fecprc2") . H::GetPost("feccau2");
        // tipo
        $this->tipprc1 = H::GetPost("tipprc1") . H::GetPost("tipcau1");
        $this->tipprc2 = H::GetPost("tipprc2") . H::GetPost("tipcau2");
        // combo
    ...
    function Cuerpo() {
        ...
        foreach ($this->arrp as $dato) {
            if ($dato["referencia"] != $ref) {
                ...
                $this->ln();
                $aver = strlen($this->descripcion) / 60;
                $this->ln($aver * 3);
                //if(strlen($this->descripcion)>150){$this->ln();}
                if (strlen($this->benefi) > 24) {
                    $this->ln();
                }
            }
            $ref = $dato["referencia"];
