<?
	...
	class pdfreporte extends fpdf
	{
		...
		function llenartitulosmaestro()
		{
				...
				$this->titulos[2]="         Total";
				$this->titulos[3]="            Pagado";
				...
				$this->titulos2[0]="";
				$this->titulos2[1]="                       ";
				$this->titulos2[2]="      Asignado";
				$this->titulos2[3]="                 ";
				$this->titulos2[4]="     Presupuestaria";
		...
		function Header()
		{
			...
			$this->cab->poner_cabecera($this,"DISPONIBILIDAD PRESUPUESTARIA","p","s");
