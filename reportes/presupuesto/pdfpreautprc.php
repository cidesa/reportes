    ...
    class pdfreporte extends fpdf
	{
		...
		//   $this->Cell(200,5,'IMPUTACIÓN PRESUPUESTARIA',0,0,'C');
		 ...
		 /*  $this->Rect(10,70,10,7,'DF');
		   ...
		   $this->SetXY(20,70);
		   $this->SetFont("Arial","B",8);
		   $this->Cell(30,7,'CÓDIGO PRESUPUESTARIO',0,0,'C');
		   //Descripcion
		...
		//   $this->Line(20,70,20,220);
		 //  $this->Line(30,70,30,220);
		   ...
		   $this->SetXY(10,235);
		   $this->SetFont("Arial","B",8);
		   $this->Cell(50,5,'Analista de Presupuesto',0,0,'C');
		   $this->Rect(10,235,50,25);
		   $this->Cell(50,5,'Jefe(a) de Presupuesto',0,0,'C');
		   $this->Rect(60,235,50,25);
		   $this->SetFont("Arial","",8);
		   $this->SetXY(10,242);
		   ...
		   $this->SetXY(110,235);
		   $this->SetFont("Arial","B",8);
		   $this->Cell(50,5,'Dir. de Planificacion y Presupuesto',0,0,'C');
		   $this->Rect(110,235,50,25);
		   $this->Cell(50,5,'Dir. General Ejecutivo',0,0,'C');
		   $this->Rect(160,235,50,25);
		   $this->SetFont("Arial","",8);
		   $this->SetXY(110,242);
		   $this->Cell(10,2,'Sello y Firma:');
		   $this->SetXY(110,255);
