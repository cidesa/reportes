...
//H::printR($this->sql);exit;
		...
		function llenartitulosmaestro()
		{
				...
				$this->titulos[3]="MODIFICACION AUMENTO";
				$this->titulos[4]="MODIFICACION DISMINUCIONES";
				$this->titulos[5]="ASIGNACIÓN MODIFICADA";
				$this->titulos[6]="PRECOMPROMISO";
				$this->titulos[7]="COMPROMISOS";
				$this->titulos[8]="CAUSADO";
				$this->titulos[9]="PAGADO";
				$this->titulos[10]="DEUDA";
		...
		function Header()
		{
			...
			$this->cab->poner_cabecera_f_b($this,'',"l","s","s");
			...
			$this->cell(290,4,"EJECUCIÓN PRESUPUESTARIA POR ESPECÍFICA (PreCompromisos)",0,0,'C');
