<?
    ...
    require_once("../../lib/modelo/sqls/presupuesto/Precomext.class.php");
    ...
    class pdfreporte extends fpdf
    {
        ...
        function pdfreporte()
        {
            ...
            // nro de compromiso
            $this->pre1=H::GetPost("pre1").H::GetPost("numcom1");
            $this->pre2=H::GetPost("pre2").H::GetPost("numcom2");
            // fecha del compromiso
            $this->fecprc1=H::GetPost("fecprc1").H::GetPost("feccom1");
            $this->fecprc2=H::GetPost("fecprc2").H::GetPost("feccom2");
            // tipo
            $this->tipprc1=H::GetPost("tipprc1").H::GetPost("tipcom1");
            $this->tipprc2=H::GetPost("tipprc2").H::GetPost("tipcom2");
            // combo
            $this->combodes=H::GetPost("combodes").H::GetPost("estado");
            // codigo presupuestario
            $this->codpre1=H::GetPost("codpre1");
            $this->codpre2=H::GetPost("codpre2");
            //tipo de moneda
            $this->codmon1=H::GetPost("codmon1");
            $this->codmon2=H::GetPost("codmon2");
            
            //comodin
            $this->comodin=H::GetPost("comodin");


           $this->precomext= new Precomext();
           $this->arrp=$this->precomext->sqlp($this->fecprc1,$this->fecprc2,$this->tipprc1,$this->tipprc2,$this->pre1,$this->pre2,$this->codpre1,$this->codpre2,$this->codmon1,$this->codmon2,$this->comodin,$this->combodes);
        //  H::printR($this->arrp);
        ...
        function llenartitulosmaestro()
        {
                ...
                $this->titulos[6]="Moneda";
                $this->titulos[7]="Tasa de Cambio";
        }
  ...
  function llenaranchos()
    {
        ...
        function Cuerpo()
        {
            ...
            foreach($this->arrp as $dato)
            {
                ...
                $this->nommon=$dato["nommon"];
                $this->valmon=$dato["valmon"];
                $this->tipo=$dato["tipo"];
                ...
                if($this->gety()>170){$this->addpage();}
                    ...
                    $y=$this->gety();
                    $this->setxy(70,$y);
                    $this->multicell(80,4,$this->descripcion);
                    $this->setxy(155,$y);
                    $this->multicell(50,4,$this->benefi);
                    $this->setxy(205,$y);
                    $this->multicell(25,4,($this->estat),0,"L",0);
                    $this->setxy(225,$y);                   
                    $this->multicell(25,4,($this->nommon),0,"L",0);
                    //$this->multicell(25,4,"bolivar",0,"L",0);
                    $this->setxy(245,$y);
                    $this->multicell(25,4,H::FormatoMonto($this->valmon),0,"L",0);
                    //$this->multicell(25,4,"bolivar",0,"L",0);
                    $this->setxy(220,$y);
