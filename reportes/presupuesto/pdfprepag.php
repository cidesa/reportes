<?
	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			// nro de compromiso
			$this->pre1=H::GetPost("pre1").H::GetPost("refpag1");
			$this->pre2=H::GetPost("pre2").H::GetPost("refpag2");
			// fecha del compromiso
			$this->fecprc1=H::GetPost("fecprc1").H::GetPost("fecpag1");
			$this->fecprc2=H::GetPost("fecprc2").H::GetPost("fecpag2");
			// tipo
			$this->tipprc1=H::GetPost("tipprc1").H::GetPost("tippag1");
			$this->tipprc2=H::GetPost("tipprc2").H::GetPost("tippag2");
			// combo
			$this->combodes=H::GetPost("combodes").H::GetPost("estado");
			// codigo presupuestario
			$this->codpre1=H::GetPost("codpre1").H::GetPost("codpre1");
			$this->codpre2=H::GetPost("codpre2").H::GetPost("codpre2");
			//comodin
  ...
  function llenaranchos()
	...
	//	$this->anchos[5]=25;
		...
		$this->cell(0, 4, "Desde  " . $this->fecprc1 . "  Hasta  " . $this->fecprc2, 0, 0, 'C');
		$this->ln();
