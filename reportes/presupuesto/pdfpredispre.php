...
//print '<pre>'; print $this->sql;exit;
    ...
    function llenartitulosmaestro()
    {
        ...
        $this->titulos[6]="Compromisos";
        $this->titulos[7]="Gasto Causados";
        $this->titulos[8]="Gasto Pagado";
        $this->titulos[9]="Saldo Pendiente Por Pagar";
        $this->titulos[10]="Disponibilidad Presupuestaria";
    ...
    //	$this->cell(340,4,"Disponibilidad Presupuestaria",0,0,'C');
      ...
      $this->setBorder(1);
      $this->setWidths(array(38,51,28,28,28,28,28,28,28,28,28));
      ...
      $this->rowM(array($this->titulos[0],$this->titulos[1],$this->titulos[2],$this->titulos[3],$this->titulos[4],$this->titulos[5],$this->titulos[6],$this->titulos[7],$this->titulos[8],$this->titulos[9],$this->titulos[10]));
      $this->ln(3);
