<?
	...
	require_once("../../lib/modelo/sqls/viaticos/Viarliscal.class.php");
		...
		function pdfreporte()
		{
			...
			$this->arrp =$this->obj->SQLp($this->codempdes,$this->codemphas,$this->codcatdes,$this->codcathas,$this->codnivdes,$this->codnivhas,$this->codciudes,$this->codciuhas,$this->codprodes,$this->codprohas,$this->codfordes,$this->codforhas,$this->agrupor1,$this->agrupor2,$this->fecdes,$this->fechas,$this->status,$this->tipvia);
                ...
                function arreglos()
                {
                    if($this->agrupor1=='E')
                    {
                        $this->arreglowidth = array(22,15,16,20,50,20,30,10,20,23,25);
                        $this->arregloalign = array("C","C","C","C","L","C","C","C","C","C","R");
                        $this->arreglorow =   array("N°CALCULO","FECHA",'SOLICIT.',"TIPO","CATEGORIA","CIUDAD",'FECHA VIAJE','DIAS','STATUS','COMPROMISO','MONTO');
                    }elseif($this->agrupor1=='C')
                    {
                        $this->arreglowidth = array(22,15,16,20,50,20,30,10,20,23,25);
                        $this->arregloalign = array("C","C","C","C","L","C","C","C","C","C","R");
                        $this->arreglorow =   array("N°CALCULO","FECHA",'SOLICIT.',"TIPO","EMPLEADO","CIUDAD",'FECHA VIAJE','DIAS','STATUS','COMPROMISO','MONTO');
                    }
                    elseif($this->agrupor1=='D')
                    {
                        $this->arreglowidth = array(22,15,16,20,40,40,30,10,20,23,25);
                        $this->arregloalign = array("C","C","C","C","L","L","C","C","C","C","R");
                        $this->arreglorow =   array("N°CALCULO","FECHA",'SOLICIT.',"TIPO","EMPLEADO","CATEGORIA",'FECHA VIAJE','DIAS','STATUS','COMPROMISO','MONTO');
                    }
                    else
                    {
