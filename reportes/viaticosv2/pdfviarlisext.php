<?
	...
	require_once("../../lib/modelo/sqls/viaticos/Viarlisext.class.php");
	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->arrp =$this->obj->SQLp($this->codempdes,$this->codemphas,$this->codcatdes,$this->codcathas,$this->codnivdes,$this->codnivhas,$this->codciudes,$this->codciuhas,$this->codprodes,$this->codprohas,$this->codfordes,$this->codforhas,$this->agrupor1,$this->agrupor2,$this->fecdes,$this->fechas,$this->status,$this->tipvia);
                ...
                function arreglos()
                {
                    if($this->agrupor1=='E')
                    {
                        $this->arreglowidth = array(22,15,20,20,50,20,35,10,23,25);
                        $this->arregloalign = array("C","C","C","C","L","C","C","C","C","R");
                        $this->arreglorow =   array("N° EXTENSION","FECHA",'N° CALCULO',"TIPO","CATEGORIA","CIUDAD",'FECHA VIAJE','DIAS','COMPROMISO','MONTO');
                    }elseif($this->agrupor1=='C')
                    {
                        $this->arreglowidth = array(22,15,20,20,50,20,35,10,23,25);
                        $this->arregloalign = array("C","C","C","C","L","C","C","C","C","R");
                        $this->arreglorow =   array("N° EXTENSION","FECHA",'N° CALCULO',"TIPO","EMPLEADO","CIUDAD",'FECHA VIAJE','DIAS','COMPROMISO','MONTO');
                    }
                    elseif($this->agrupor1=='D')
                    {
                        $this->arreglowidth = array(22,15,20,20,40,40,35,10,23,25);
                        $this->arregloalign = array("C","C","C","C","L","L","C","C","C","R");
                        $this->arreglorow =   array("N° EXTENSION","FECHA",'N° CALCULO',"TIPO","EMPLEADO","CATEGORIA",'FECHA VIAJE','DIAS','COMPROMISO','MONTO');
                    }
                    else
                    {
                        $this->arreglowidth = array(22,15,20,20,35,35,20,30,10,23,20);
                        $this->arregloalign = array("C","C","C","C","L","L","C","C","C","C","R");
                        $this->arreglorow =   array("N° EXTENSION","FECHA",'N° CALCULO',"TIPO","EMPLEADO","CATEGORIA","CIUDAD",'FECHA VIAJE','DIAS','COMPROMISO','MONTO');
                    }
                }
		...
		{                    
		    ...
		    foreach($this->arrp as $arr)
		    {
                        ...
                        if($this->agrupor1=='E')
                            $this->Rowm(array($arr['numcal'],$arr['feccal'],$arr['numsol'],$tipvia,
