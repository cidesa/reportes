<?
	...
	require_once("../../lib/modelo/sqls/viaticos/Viarlisniv.class.php");
	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->obj = new Viarlisniv();
			$this->arrp =$this->obj->SQLp($this->codnivdes,$this->codnivhas);
		}
		...
		function header()
		{
			...
			$this->setAligns('C');
                        ...
                        $this->setBorder(true);
                        $this->setFilltable(1);
			$this->Rowm(array("CODIGO NIVEL","DESCRIPCION NIVEL"));
                        $this->setFilltable(0);
