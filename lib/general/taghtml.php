	...
	if (count($text)>3 && count($text)==6)
	{
		$script ='
		  <tr>
             ...
             <td width="'.$opc[1].'">
             	<div align="left">
               	  <input name="'.$text[0].'" type="text" class="breadcrumb" id="'.$text[0].'" value="'.$text[1].'" '.$parametros.' size ="'.$opc[0].'">
 			    </div>
 			 </td>
             <td width="'.$opc[1].'">
             	<div align="left">
               	  <input name="'.$text[3].'" type="text" class="breadcrumb" id="'.$text[3].'" value="'.$text[4].'" '.$parametros.' size ="'.$opc[0].'">
 			    </div>
 			 </td>
           </tr>';
	}else
