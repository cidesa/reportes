...
function sqlp($refdes,$refhas,$fecdes,$fechas,$coddes,$codhas)
  {
  	...
  	$sql="	select distinct a.refprc as refprc,b.codpre as codpre,a.fecprc as fecprc,d.perpre as perpre,
  			a.desprc as desprc,c.nomben as nomben,d.monasi as monasi,b.monimp as monimp,d.montra as montra,d.montrn as montrn,d.monasi as monasi,d.mondim as mondim
