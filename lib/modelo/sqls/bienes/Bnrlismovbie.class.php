...
class Bnrlismovbie extends baseClases
{


function sqlp($coddisdes,$coddishas,$codubides,$codubihas,$codubides2,$codubihas2,$codbiemin,$codbiemax)
  {
  	  $sql="select
			...
			SUBSTR(a.tipdismue,0,11 ) >= RTRIM('".$coddisdes."') and
			SUBSTR(a.tipdismue,0,11 ) <= RTRIM('".$coddishas."') and
			...
			";
//print '<pre>';  print $sql; exit; //entonces
