...
class Oce705 extends baseClases{
	...
	function sqlp($tri,$form){
		...
		$sql="select codcta,descta,preapr,premod,prgtri,comtri,cautri,pagtri,prgaltri,comaltri,caualtri,pagaltri,mondis, r.descripcion as descripcion,cuenta,tipo
        from (
